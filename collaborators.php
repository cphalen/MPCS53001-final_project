...
<form action="/~cphalen/api/queryCollaborator.php" method="post">
	...
	<div class="form-group col-6">
        ...
        <label class="btn btn-sm btn-secondary">
            <input name="ToggleActors" type="checkbox" autocomplete="off"> Actors
        </label>
        <label class="btn btn-sm btn-secondary">
            <input name="ToggleWriters" type="checkbox" autocomplete="off"> Writers
        </label>
        <label class="btn btn-sm btn-secondary">
            <input name="ToggleDirectors" type="checkbox" autocomplete="off"> Directors
        </label>
        <br>
        <br>
    </div>
